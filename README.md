Setup flask page to let the user build and add classes to mongodb. When in the schedule builder page it will load the mongodb classes into the knowledgebase using prolog.assertz.
